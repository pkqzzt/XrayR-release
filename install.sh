...
install_XrayR() {
    ...
    if  [ $# == 0 ] ;then
        last_version=$(curl -Ls "https://mirror.ghproxy.com/https://api.github.com/repos/XrayR-project/XrayR/releases/latest" | grep '"tag_name":' | sed -E 's/.*"([^"]+)".*/\1/')
        ...
        url="https://mirror.ghproxy.com/https://github.com/XrayR-project/XrayR/releases/download/${last_version}/XrayR-linux-${arch}.zip"
    ...
    file="https://mirror.ghproxy.com/https://github.com/XrayR-project/XrayR-release/raw/master/XrayR.service"
    ...
    curl -o /usr/bin/XrayR -Ls https://mirror.ghproxy.com/https://raw.githubusercontent.com/XrayR-project/XrayR-release/master/XrayR.sh
